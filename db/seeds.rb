...
# 2nd 
Student.create(:name =>"Ali", :age => "48",:father_name => "Hamza",:phone_number => "0080",:email => "aliahmed@625",:blood_group => "B-" )

# 3rd student.save
student = Student.create(:name =>"ABR", :age => "28",:father_name => "Riaz",:phone_number => "233480",:email => "abr@625",:blood_group => "A-" )

# StudentClass Table 2
# First recode  
# s_class = Student.create(section_name: "B", teacher_name: "Ahmed", student_name: "Ali" )
# # 2nd recode
...
# s_class = ap StudentClass.new(section_name: "A", teacher_name:
